...
This project is indexed by GitNexus as **roll-agent** (5454 symbols, 13380 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
