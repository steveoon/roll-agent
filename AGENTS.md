...
This project is indexed by GitNexus as **roll-agent** (6316 symbols, 15838 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
