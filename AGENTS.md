...
This project is indexed by GitNexus as **roll-agent** (6118 symbols, 15348 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
