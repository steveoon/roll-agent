...
This project is indexed by GitNexus as **roll-agent** (7317 symbols, 18580 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
