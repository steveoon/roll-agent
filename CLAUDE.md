...
This project is indexed by GitNexus as **roll-agent** (6652 symbols, 16722 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
