...
This project is indexed by GitNexus as **roll-agent** (5396 symbols, 13241 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
