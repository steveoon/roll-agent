...
This project is indexed by GitNexus as **roll-agent** (7297 symbols, 18542 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
