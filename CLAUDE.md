...
roll schedule add|list|show|remove|pause|resume|run-now|runs|cancel|status|daemon|service   定时任务
roll doctor                                  系统诊断
```
