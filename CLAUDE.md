...
This project is indexed by GitNexus as **roll-agent** (8644 symbols, 16619 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
