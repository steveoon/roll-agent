...
- [#278](https://github.com/steveoon/roll-agent/pull/278) [`39d4f69`](https://github.com/steveoon/roll-agent/commit/39d4f6990883feaf16855e3f55380547e9642867) Thanks [@steveoon](https://github.com/steveoon)! - Read Windows process creation times without loading PowerShell management cmdlets, avoiding ARM64 timeouts that blocked Agent lifecycle locks and installation or upgrade checks. Reserve time for a trusted fallback when the first PowerShell candidate stalls, while preserving the overall deadline, process identity tokens, trusted executable paths, and fail-closed verification.

  Query Windows Companion and scheduler task state without depending on PowerShell utility cmdlets, preventing the same class of stall during post-upgrade service inspection.
...
- Updated dependencies [[`25048bf`](https://github.com/steveoon/roll-agent/commit/25048bfe7568c0588a1ea93fda595cd2e9aaf716)]:
  - @roll-agent/runtime@0.24.0
  - @roll-agent/protocol@0.7.0
  - @roll-agent/client-node@0.6.0
  - @roll-agent/companion@0.5.0
...
- [#268](https://github.com/steveoon/roll-agent/pull/268) [`f05c994`](https://github.com/steveoon/roll-agent/commit/f05c994089ef06d4fc67352606af2160915482fe) Thanks [@steveoon](https://github.com/steveoon)! - 支持指定未来开始时间的间隔任务，以及每天/每周的日历任务。默认使用运行 Roll 的机器时区，创建时保存日历时区；CLI 与聊天创建、确认、列表和追加轮数沿用同一规则。保留自动轮数、重试、单例和最多一次补跑语义，明确处理夏令时跳时/重复钟点。调度账本升级至 v9 并保留旧任务与历史，升级后需重启调度服务。
...
- Updated dependencies [[`f05c994`](https://github.com/steveoon/roll-agent/commit/f05c994089ef06d4fc67352606af2160915482fe)]:
  - @roll-agent/runtime@0.23.0
...
- [#262](https://github.com/steveoon/roll-agent/pull/262) [`af3fa4f`](https://github.com/steveoon/roll-agent/commit/af3fa4f03b5bc054b9472d3b27ba22dd92412ff8) Thanks [@steveoon](https://github.com/steveoon)! - 支持定时任务自动执行有限轮数：CLI 使用 `--rounds`，聊天可直接指定执行次数。轮数持久化计数，重试和手动运行不额外占用自动额度；最后一轮结算后任务自动结束并保留历史。CLI、聊天历史和配置台展示进度及已结束状态。
...
- Updated dependencies [[`af3fa4f`](https://github.com/steveoon/roll-agent/commit/af3fa4f03b5bc054b9472d3b27ba22dd92412ff8)]:
  - @roll-agent/runtime@0.22.0

## 0.38.3

### Patch Changes

- Updated dependencies [[`bd256ff`](https://github.com/steveoon/roll-agent/commit/bd256ff241517015aa08636c0159c3d5a20b8076)]:
  - @roll-agent/runtime@0.21.0
...
- [#246](https://github.com/steveoon/roll-agent/pull/246) [`bf24b63`](https://github.com/steveoon/roll-agent/commit/bf24b636f1c3144fa0adbf09de4a1cea6d1568a8) Thanks [@steveoon](https://github.com/steveoon)! - fix(chat): 修复长会话内存无界增长导致 V8 堆 OOM（[#242](https://github.com/steveoon/roll-agent/issues/242)）
...
- [#239](https://github.com/steveoon/roll-agent/pull/239) [`d069ce0`](https://github.com/steveoon/roll-agent/commit/d069ce064629db6bff5653e44b820b9a01e92420) Thanks [@steveoon](https://github.com/steveoon)! - stdio Agent 可声明单条 MCP 消息的读缓冲上限 `maxBufferSize`（字节）。
...
- [#239](https://github.com/steveoon/roll-agent/pull/239) [`af2dd3f`](https://github.com/steveoon/roll-agent/commit/af2dd3f021d2f8efaaf3745e7487db9fb833e6d0) Thanks [@steveoon](https://github.com/steveoon)! - roll ui 的定时任务配置语义补全：
...
- Updated dependencies [[`63be2a8`](https://github.com/steveoon/roll-agent/commit/63be2a8c26d94aa0d200b6cbcb49fb4a0258649b), [`185e363`](https://github.com/steveoon/roll-agent/commit/185e3634500c9c8c0313f11542be1354c3593a39), [`af2dd3f`](https://github.com/steveoon/roll-agent/commit/af2dd3f021d2f8efaaf3745e7487db9fb833e6d0), [`90abbe5`](https://github.com/steveoon/roll-agent/commit/90abbe5dce3928202d62ece03a68661254d7c947)]:
  - @roll-agent/runtime@0.19.0
...
- Updated dependencies [[`c84bc83`](https://github.com/steveoon/roll-agent/commit/c84bc833c3abc095540ebfbb2d27610b538778f1)]:
  ...
  - @roll-agent/runtime@0.18.1
  - @roll-agent/client-node@0.5.2
  - @roll-agent/companion@0.4.4
...
- Updated dependencies [[`f5a9804`](https://github.com/steveoon/roll-agent/commit/f5a98040522d7b0adb5d39821e35e1f2fb8047a6), [`5ba685c`](https://github.com/steveoon/roll-agent/commit/5ba685cce832687b60c5abc49d6304e74352165c), [`3e4e06b`](https://github.com/steveoon/roll-agent/commit/3e4e06b12b145c3ca29691904ff55ad591e39f90), [`e7d2b15`](https://github.com/steveoon/roll-agent/commit/e7d2b157efd3c5f87226852991e35c77aea9a91f)]:
  - @roll-agent/runtime@0.17.0
  - @roll-agent/client-node@0.5.1
  - @roll-agent/companion@0.4.3
...
- Updated dependencies [[`6841eb5`](https://github.com/steveoon/roll-agent/commit/6841eb5b30694b36cb97863507aa9e0f61f00366), [`547f370`](https://github.com/steveoon/roll-agent/commit/547f3709d8d269c92a6d55258434ca912b13f7cc)]:
  - @roll-agent/runtime@0.15.1
  - @roll-agent/client-node@0.5.0
  - @roll-agent/companion@0.4.2
...
- Updated dependencies [[`4393302`](https://github.com/steveoon/roll-agent/commit/4393302ed4407ee5abeff7f23e57066d0ac146b6)]:
  - @roll-agent/companion@0.4.0
  - @roll-agent/relay-protocol@0.3.0
  - @roll-agent/runtime@0.14.1
  - @roll-agent/client-node@0.3.1
...
- [#198](https://github.com/steveoon/roll-agent/pull/198) [`bc0e758`](https://github.com/steveoon/roll-agent/commit/bc0e75860c7e53ed04b15b27cafd3931098efc6e) Thanks [@steveoon](https://github.com/steveoon)! - Add typed `roll__user_input` forms to the Ink and basic REPL chat surfaces, and document a
  generation-bound Electron reference handler for Runtime Protocol 1.2 user input requests.
...
- Updated dependencies [[`df979d9`](https://github.com/steveoon/roll-agent/commit/df979d98dcf09250f6705a599b42c13bafba915a), [`c9597e3`](https://github.com/steveoon/roll-agent/commit/c9597e3520059701640f3cc33cf7bf1be0bf0e8d), [`fda44ec`](https://github.com/steveoon/roll-agent/commit/fda44ec80bd87fae0492d4f41fbd7677f680e733), [`e17ca19`](https://github.com/steveoon/roll-agent/commit/e17ca19259e5b8a263aa99bfa0979e475ab3c00d)]:
  - @roll-agent/runtime@0.14.0
